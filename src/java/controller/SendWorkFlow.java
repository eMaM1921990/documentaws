...
public class SendWorkFlow extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String workflow_id=request.getParameter("id");
        String comments=request.getParameter("com");
        String fileid=request.getParameter("fil");
        System.out.println("Work flow "+workflow_id);
        System.out.println("Comment "+comments);
        System.out.println("File "+fileid);
        LoginBeans login=(LoginBeans)request.getSession().getAttribute("loginsession");
