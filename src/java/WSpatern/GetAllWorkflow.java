...
public class GetAllWorkflow {
    ...
    public void getWorkFlow(String token,String steptype) {
        try {
            ...
            HttpGet get = new HttpGet("https://documenta-dms.com/DMSWS/api/v1/flow/" + token + "/get/A/W/"+steptype);
    ...
    public static void main(String args[]){
        GetAllWorkflow g=new GetAllWorkflow();
        g.getWorkFlow("c6aeefbfbdefbfbd20efbfbd37efbfbdefbfbdefbfbd427ec69fefbfbdefbfbd54610defbfbd7befbfbdefbfbd1fefbfbd2020efbfbdefbfbd64efbfbd4a","ATRIBUIRE");
    }
}
